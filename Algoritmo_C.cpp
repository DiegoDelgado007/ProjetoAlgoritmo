...
// Anotação Parte 3: Fila de livros (agora baseada em lista encadeada) Uso de ponteiros para o ptimeiro nó da fila, ultimo nó e controle dos números de livros 
